          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            {socialIcons.map((s) => (
              <Link
                ...
                href="#"
                aria-label={s.label}
                className="w-9 h-9 rounded-lg border border-white/20 flex items-center justify-center text-white/60 hover:text-white hover:border-orange hover:bg-orange/20 transition-all duration-300"
              >
                {s.icon}
              </Link>
            ))}
            ...
            <div className="flex gap-3">
              {instagramImages.map((img, i) => (
                <div key={i} className="relative h-20 w-20 rounded-xl overflow-hidden group cursor-pointer shrink-0">
                  ...
                  />
                  <div className="absolute inset-0 bg-black/20 group-hover:bg-black/5 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
